<section id="qr-card">
    <div class="qrcard-infos">
        
        <div class="qrcard-container">
            <div id="qr-code"></div>
        </div>
        <p class="qr-url">
            spray.sampa.br/<?php echo $gen_url; ?>
        </p>
        
        <address>
            <p>
                <strong>Endereço <?php echo $gen_url; ?>:</strong> <?php echo $gen_address; ?>
            </p>

            <p>
                <strong>Email <?php echo $gen_url; ?>:</strong> <a href="mailto:<?php echo $gen_email; ?>"><?php echo $gen_email; ?></a>
            </p>

            <p>
                <strong>Telefone <?php echo $gen_url; ?>:</strong> <a href="tel:<?php echo $gen_phone; ?>"><?php echo $gen_phone; ?></a>
            </p>
        </address>
    </div>

    <div class="qrcard-map">
        <iframe 
                title="<?php echo $gen_url; ?> | <?php echo $gen_address; ?>"
                src="<?php echo $gen_map; ?>" 
                allowfullscreen="" 
                loading="lazy" 
...
<section class="qrcard-social">
    <h2>Redes Sociais <?php echo $gen_url; ?></h2>

    <ul>
        <li>
            <a 
               href="<?php echo $gen_facebook; ?>" 
               target="_blank" 
               aria-label="Facebook <?php echo $gen_url; ?>">
        ...
        <li>
            <a 
               href="<?php echo $gen_instagram; ?>" 
               target="_blank" 
               aria-label="Instagram <?php echo $gen_url; ?>">
        ...
        <li>
            <a 
               href="<?php echo $gen_linkedin; ?>" 
               target="_blank" 
               aria-label="Linkedin <?php echo $gen_url; ?>">
        ...
        <li>
            <a 
               href="<?php echo $gen_tiktok; ?>" 
               target="_blank" 
               aria-label="Tiktok <?php echo $gen_url; ?>">
        ...
        <li>
            <a 
               href="<?php echo $gen_youtube; ?>" 
               target="_blank" 
               aria-label="Youtube <?php echo $gen_url; ?>">
...
<script type="text/javascript">
    var qrcode = new QRCode("qr-code", {
        text: "https://spray.sampa.br/<?php echo $gen_url; ?>",
        width: 2000,
        height: 2000,
        colorDark : "#000000",
        colorLight : "#ffffff",
    ...
    setTimeout(function() {
        var qrCodeImage = document.querySelector("#qr-code img");
        if (qrCodeImage) {
            qrCodeImage.alt = "QR Code para a página spray.sampa.br/<?php echo $gen_url; ?>";
        }
    }, 100);
</script>