    ...
    <div class="company-container">
        ...
        <div class="company-about">
            ...
            <p>
                ...
                Whether you're writing a blog post, crafting social assets updates, or refining website copy, 
        ...
        <div class="swiper company-pics">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide"><img src="assets/company-image1.webp"></div>
                <div class="swiper-slide"><img src="assets/company-image2.webp"></div>
                <div class="swiper-slide"><img src="assets/company-image3.webp"></div>
...
<section>
    <div class="title-box">
        <h1 class="title-1">Company Video</h1>
        <h1 class="title-4">Show the best angles of your company</h1>
    </div>
...
<section class="company">
    <div class="title-box">
        <h1 class="title-1">WhatsApp Prints</h1>
        <h1 class="title-4">Show your audience in your messengers</h1>
    </div>
    ...
    <div class="swiper company-prints">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="assets/whatsapp-print.webp">
            </div>
