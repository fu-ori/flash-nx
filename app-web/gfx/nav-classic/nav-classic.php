...
<nav class="nav-classic">
    ...
    <div class="nav-classic-cta">
        <a onclick="openContact()" class="btn" href="#">Your CTA</a>
    </div>

    <div class="nav-classic-mobile">
        <a onclick="openNavClassicMobileMenu()"><i class="ph ph-dots-nine"></i></a>
    </div>
</nav>
...
<script type="text/javascript">
    gsap.set(".nav-classic-mobile-menu", { autoAlpha: 0 }); 

    function openNavClassicMobileMenu() {
        gsap.to(".nav-classic-mobile-menu", { duration: 0.5, autoAlpha: 1, ease: "power2.out" });
    }

    function closeNavClassicMobileMenu() {
        gsap.to(".nav-classic-mobile-menu", { duration: 0.5, autoAlpha: 0, ease: "power2.in" });
    }
</script>